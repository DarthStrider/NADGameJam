...
public class BlimpExplosion : MonoBehaviour {
	...
	void Update () {
        if (timer == 0)
        {
            ...
            a.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(a, .63f);
        }
        else if (timer > 0.1 && timer < 0.2f)
        {
            ...
            b.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(b, .83f);
        }
        else if (timer > 0.2 && timer < 0.3f)
        {
            ...
            c.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(c, .83f);
        }
        else if (timer > 0.3 && timer < 0.4f)
        {
            ...
            d.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(d, .83f);
        }
        else if (timer > 0.4 && timer < 0.5f)
        {
            ...
            e.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(e, .83f);
        }
        else if (timer > 0.5f && timer < 0.6f)
        {
            ...
            f.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(f, .83f);
        }
        else if (timer > 0.7 && timer < 0.8f)
        {
            ...
            g.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(g, .83f);
        }
        else if (timer > 0.8 && timer < 0.9f)
        {
            ...
            h.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(h, .83f);
        }
        else if (timer > 1 && timer < 1.1f)
        {
            ...
            i.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(i, .83f);
        }
        else if (timer > 1.1 && timer < 1.2f)
        {
            ...
            j.transform.localScale = new Vector3(2f, 2f, 1);
            Destroy(j, .83f);
        }
